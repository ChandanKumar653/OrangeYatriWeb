        ...
        <div className="w-full md:w-1/2 lg:w-2/3">
          <div className="px-4 md:px-0 text-center md:text-left ">
            ...
            >
              ...
              <span className="text-orange-400">About Our Pilot App</span>
            </h1>
            <p
            ...
            >
              ...
              Quisque fringilla dolor eu fringilla molestie. Lorem ipsum dolor
              sit amet, consectetur adipiscing elit. Fusce porta ante sed
              egestas ultrices. Fusce a massa porttitor, tempor neque at,
              vehicula metus. Ut tristique ipsum neque, vitae imperdiet turpis
              placerat vitae.
            </p>
